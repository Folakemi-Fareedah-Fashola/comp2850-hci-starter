...
**Input Method**: Keyboard(tab, enter, space)
...
- **Start**: [19:57:32]
- **End**: [19:59:32] (timed out)
- **Duration**: [120s]
- **Outcome**: Failure
- **Errors**: Could not reach edit button using solely keyboard navigation 
- **Confidence**: 1
- **Observations**:
  - Pilot tried using tab several time to get to edit button but would only go back and forth from add task to filter task 
  - Pilot got a little bit frustrated 
  - Tried using a bunch of keys on the keyboard, none worked 

---

## Task 4: Delete Task (Buy oat milk)
- **Start**: [20:04:19]
- **End**: [20:06:19] (timed out)
- **Duration**: [120s]
- **Outcome**: Failure
- **Errors**: Could not reach delete button using solely keyboard navigation 
- **Confidence**: 1
- **Observations**:
  - Similar to edit, pilot was very confused about how to navigate to the delete task, kept pushing space bar or tab but either scrolling down or only switching between add and filter
